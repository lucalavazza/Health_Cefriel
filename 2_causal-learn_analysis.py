...
if data_type == 'encoded':
    drop_cols = ['participant_id', 'height_cm', 'weight_kg', 'gender_M', 'gender_F', 'gender_Other', 'stress_level', 'health_condition']
else:
    drop_cols = ['participant_id', 'height_cm', 'weight_kg', 'gender', 'stress_level', 'health_condition']
...
# PC
# cits = ['fisherz', 'chisq', 'gsq', 'kci']  # chisq takes A LOT (~90 mins), while kci was still computing after 16 hours
cits = ['fisherz']
for cit in cits:
