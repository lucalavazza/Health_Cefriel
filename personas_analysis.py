...
counterfactual_data2 = gcm.counterfactual_samples(causal_model_for_counterfactual_analysis,
                                                  ...
                                                  observed_data=fitness_data_pid)
array_plot = np.array(
    [fitness_data_pid['resting_heart_rate'], counterfactual_data1['resting_heart_rate'], counterfactual_data2['resting_heart_rate']])
months = ['january', 'february', 'march', 'april', 'may', 'june', 'july', 'august', 'september', 'october',
          'november', 'december']
df_plot = pd.DataFrame(array_plot, columns=months, index=['resting_heart_rate when smoking', 'resting_heart_rate when quitting',
...
array_plot = np.array([fitness_data_pid['calories_burned'], counterfactual_data1['calories_burned'], counterfactual_data2['calories_burned']])
...
counterfactual_data1 = gcm.counterfactual_samples(causal_model_for_counterfactual_analysis,
                                                  ...
                                                  observed_data=fitness_data_pid)
array_plot = np.array(
    [fitness_data_pid['calories_burned'], fitness_data_pid['fitness_level'], fitness_data_pid['resting_heart_rate'],
     fitness_data_pid['bmi'], counterfactual_data1['calories_burned'], counterfactual_data1['fitness_level'],
     counterfactual_data1['resting_heart_rate'], counterfactual_data1['bmi']])
months = ['january', 'february', 'march', 'april', 'may', 'june', 'july', 'august', 'september', 'october',
          'november', 'december']
df_plot = pd.DataFrame(array_plot, columns=months, index=['calories before', 'fit level before', 'heart before', 'bmi before',
...
months = ['january', 'february', 'march', 'april', 'may', 'june', 'july', 'august', 'september', 'october',
          'november', 'december']
df_plot = pd.DataFrame(array_plot, columns=months, index=['calories_burned when smoking', 'calories_burned when quitting',
