...
for pid in pids_personas:
    if pid == 2:
        ...
        p = np.poly1d(z)
        ax[0].plot(months, p(x), color='pink')
        ...
        p = np.poly1d(z)
        ax[1].plot(months, p(x), color='pink')
        ...
        p = np.poly1d(z)
        ax[2].plot(months, p(x), color='pink')
        ...
        p1 = np.poly1d(z1)
        ax.plot(months, p1(x), color='blue')
        z2 = np.polyfit(months_int, perc2, 1)
        p2 = np.poly1d(z2)
        ax.plot(months, p2(x), color='orange')
        ax.set_ylabel('%')
        ...
        diff3 = np.subtract(np.array(counterfactual_data1['bmi']), np.array(fitness_data_pid['bmi']))
        perc0 = []
        perc1 = []
        perc2 = []
        perc3 = []
        for i in range(len(months)):
            ...
            max_v0 = np.array(fitness_data_pid['calories_burned'])[i]
            max_v1 = np.array(fitness_data_pid['fitness_level'])[i]
            max_v2 = np.array(fitness_data_pid['resting_heart_rate'])[i]
            max_v3 = np.array(fitness_data_pid['bmi'])[i]
            perc_0 = diff_0 / abs(max_v0)
            perc_1 = diff_1 / abs(max_v1)
            perc_2 = diff_2 / abs(max_v2)
            perc_3 = diff_3 / abs(max_v3)
            perc0.append(int(perc_0))
            perc1.append(int(perc_1))
            perc2.append(int(perc_2))
            perc3.append(int(perc_3))
        x = np.arange(len(months))  # the label locations
        width = 0.65  # the width of the bars
        ...
        # ax[0].grid(True, linestyle='-.')
        ax[0].set_ylabel('%')
        ax[0].set_title('Percentual difference in calories_burned when increasing duration_minutes')
        ax[0].set_xticks(x, months)
        p1 = ax[1].bar(months, perc1, width, color='tab:red')
        ax[1].bar_label(p1, fmt=lambda x: x)
        z = np.polyfit(months_int, perc1, 1)
        ...
        # ax[1].grid(True, linestyle='-.')
        ax[1].set_ylabel('%')
        ax[1].set_title('Percentual difference in fitness_level when increasing duration_minutes')
        ax[1].set_xticks(x, months)
        p2 = ax[2].bar(months, perc2, width, color='tab:blue')
        ax[2].bar_label(p2, fmt=lambda x: x)
        z = np.polyfit(months_int, perc2, 1)
        ...
        # ax[2].grid(True, linestyle='-.')
        ax[2].set_ylabel('%')
        ax[2].set_title('Percentual difference in resting_heart_rate when increasing duration_minutes')
        ax[2].set_xticks(x, months)
        p3 = ax[3].bar(months, perc3, width, color='tab:pink')
        ax[3].bar_label(p3, fmt=lambda x: x)
        z = np.polyfit(months_int, perc3, 1)
        p = np.poly1d(z)
        ax[3].plot(months, p(x), color='pink')
        # ax[2].grid(True, linestyle='-.')
        ax[3].set_ylabel('%')
        ax[3].set_title('Percentual difference in bmi when increasing duration_minutes')
        ...
        z = np.polyfit(months_int, perc0, 1)
        p = np.poly1d(z)
        ax.plot(months, p(x), color='pink')
        # ax[0].grid(True, linestyle='-.')
        ax.set_ylabel('%')
        ax.set_title('Percentual difference in calories_burned when increasing daily steps and duration_minutes')
        ...
        # ax[0].grid(True, linestyle='-.')
        ax.set_ylabel('%')
        ax.set_title('Percentual difference in calories_burned when increasing fitness_level')
        ax.set_xticks(x, months)
        ...
        ax.plot(months, p2(x), color='orange')
        ax.set_ylabel('%')
        ax.set_title('Percentual difference in calories_burned only doing one sport')
        ax.set_xticks(x + width, months)
        ax.legend(loc='upper left', ncols=2)
        plt.savefig(
        ...
        for i in range(len(months)):
            diff_0 = diff0[i] * 100
            max_v0 = np.array(fitness_data_pid['bmi'])[i]
            perc_0 = diff_0 / abs(max_v0)
            perc0.append(int(perc_0))
        x = np.arange(len(months))  # the label locations
        width = 0.65  # the width of the bars
        ...
        # ax[0].grid(True, linestyle='-.')
        ax.set_ylabel('%')
        ax.set_title('Percentual difference in bmi when lowering calories_burned')
        ax.set_xticks(x, months)
        ...
        for i in range(len(months)):
            ...
            diff_1 = diff1[i] * 100
            diff_2 = diff2[i] * 100
            max_v0 = np.array(fitness_data_pid['blood_pressure_systolic'])[i]
            max_v1 = np.array(fitness_data_pid['blood_pressure_diastolic'])[i]
            max_v2 = np.array(fitness_data_pid['resting_heart_rate'])[i]
            perc_0 = diff_0 / abs(max_v0)
            perc_1 = diff_1 / abs(max_v1)
            perc_2 = diff_2 / abs(max_v2)
        ...
        # ax[0].grid(True, linestyle='-.')
        ax[0].set_ylabel('%')
        ax[0].set_title('Percentual difference in blood_pressure_systolic when increasing duration_minutes')
        ax[0].set_xticks(x, months)
        p1 = ax[1].bar(months, perc1, width, color='tab:red')
        ax[1].bar_label(p1, fmt=lambda x: x)
        z = np.polyfit(months_int, perc1, 1)
        ...
        # ax[1].grid(True, linestyle='-.')
        ax[1].set_ylabel('%')
        ax[1].set_title('Percentual difference in blood_pressure_diastolic when increasing duration_minutes')
        ax[1].set_xticks(x, months)
        p2 = ax[2].bar(months, perc2, width, color='tab:blue')
        ax[2].bar_label(p2, fmt=lambda x: x)
        z = np.polyfit(months_int, perc2, 1)
        ...
        for i in range(len(months)):
            diff_0 = diff0[i] * 100
            diff_1 = diff1[i] * 100
            max_v0 = np.array(fitness_data_pid['fitness_level'])[i]
            max_v1 = np.array(fitness_data_pid['bmi'])[i]
            perc_0 = diff_0 / abs(max_v0)
            perc_1 = diff_1 / abs(max_v1)
            perc0.append(int(perc_0))
            perc1.append(int(perc_1))
        ...
        # ax[0].grid(True, linestyle='-.')
        ax[0].set_ylabel('%')
        ax[0].set_title('Percentual difference in fitness_level when increasing duration_minutes')
        ax[0].set_xticks(x, months)
        p1 = ax[1].bar(months, perc1, width, color='tab:red')
        ax[1].bar_label(p1, fmt=lambda x: x)
        z = np.polyfit(months_int, perc1, 1)
        ...
        # ax[1].grid(True, linestyle='-.')
        ax[1].set_ylabel('%')
        ax[1].set_title('Percentual difference in bmi when increasing duration_minutes')
        ax[1].set_xticks(x, months)
        ...
        for i in range(len(months)):
            diff_0 = diff0[i] * 100
            max_v0 = np.array(fitness_data_pid['resting_heart_rate'])[i]
            perc_0 = diff_0 / abs(max_v0)
            perc0.append(int(perc_0))
        x = np.arange(len(months))  # the label locations
        width = 0.65  # the width of the bars
        ...
        # ax[0].grid(True, linestyle='-.')
        ax.set_ylabel('%')
        ax.set_title('Percentual difference in resting_heart_rate when increasing duration_minutes')
        ax.set_xticks(x, months)
        ...
        # ax[0].grid(True, linestyle='-.')
        ax.set_ylabel('%')
        ax.set_title('Percentual difference in fitness_level when increasing duration_minutes and daily_steps')
        ax.set_xticks(x, months)
