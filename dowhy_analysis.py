...
bar_plot(dict(before=avg_calories_burned_before, after=median_mean_latencies['calories_burned']),
         ...
         filename='graphs/tests/test-intervention.pdf',
...
fig.savefig('./graphs/tests/test-counterfactual-pid=42.pdf')
fig2.savefig('./graphs/tests/test-counterfactual-pid=42-non_scaled.pdf')
...
plt.savefig('./graphs/tests/test-counterfactual-pid=42-percentual_difference.pdf')
